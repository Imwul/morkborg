...
assessments={
 ...
 'core.unclean':'Ten Power names display; their effect metadata does not render in TABLE or generic ROLL.',
 'core.sacred':'Ten Power names display; their effect metadata does not render in TABLE or generic ROLL.',
