...
const rows = JSON.parse(readFileSync('docs/pdf-escape-audit/data/supplement-rows.json', 'utf8'));
...
writeFileSync('outputs/pdf-escape-audit/supplement-search-results.json', JSON.stringify(results, null, 2));
