...
export const PLAY_REFERENCE_RULES: PlayReferenceRuleSeed[] = [
  ...
  },
  {
    ...
    pages: [8],
    printedPage: 6,
    contexts: ['character', 'monster', 'dungeon', 'room'],
  },
  {
    id: 'sd.search-move',
  ...
  },
  {
    ...
    summary:
      '두 d20 + Presence: 숨 돌리기 DR9, 야영 DR12. Strong 회복 d4/d6 HP, Weak d2/d4 HP. 수면 시 식량 1: Strong은 Omens 재굴림·Powers 회복, Weak는 각각 1 회복과 휴식 방해. Fail은 수면 없이 사건 발생; 해결 뒤 다음 휴식은 Strong/Weak를 50/50으로 정합니다.',
    book: 'sd',
    pages: [8],
    printedPage: 6,
    contexts: ['character', 'travel', 'dungeon', 'room'],
    seeFullRule: true,
  },
  {
    id: 'sd.resupply',
    title: 'SD Resupply · 재보급',
    summary:
      '여행 중이면 FER Overland Travel의 Foraging 표를 굴립니다. 그 밖의 상황에서는 General Adventuring Move로 사냥감·먹을거리·마실 만한 물을 찾습니다. 행동에 맞는 능력과 DR을 정하세요.',
    book: 'sd',
    pages: [8],
    printedPage: 6,
    contexts: ['travel', 'dungeon', 'room'],
    oracles: ['feretory.forage'],
  },
  {
    id: 'depths.threat-rating',
    title: 'Depths Threat Rating · 위험도 TR',
    summary:
      '던전의 TR은 적·함정의 난이도입니다: 쉬움 9, 보통 12, 어려움 15. 야외는 12. TR Move는 두 d20 + 지정 능력을 각각 TR과 비교합니다. 방 발견에 쓰는 Dungeon DR과 별도로 정합니다.',
    book: 'depths',
    pages: [9],
    printedPage: 6,
    contexts: ['dungeon', 'room', 'monster', 'travel'],
    seeFullRule: true,
  },
  {
    id: 'depths.enemy-detection',
    title: 'Depths Encountering Enemies · 적에게 들켰는가',
    summary:
      '두 d20 + Agility, DR은 TR. 적이 딴일 중이고 경계하지 않으면 −3, 경계 중이면 +3. Strong/Weak는 이전 방으로 바로 후퇴 가능; 잠입은 Presence TR−3/TR 판정에서 Strong 또는 Weak면 성공. 싸운다면 Strong은 선공, Weak는 선공 굴림. Fail은 반응을 굴려 적대적이면 전투, 아니면 Chaos Portents로 목적을 정합니다. Weak/Fail부터 적은 경계합니다.',
    book: 'depths',
    pages: [10],
    printedPage: 7,
    contexts: ['dungeon', 'room', 'monster'],
    oracles: [
      'core.reaction',
      'depths.chaosPortents.action',
      'depths.chaosPortents.subject',
    ],
    seeFullRule: true,
  },
  {
    id: 'depths.locked-doors',
    title: 'Depths Locked Doors · 잠긴 문과 장애물',
    summary:
      '보통 Strength/Presence로 TR Move. 잠긴 문에 락픽을 쓰면 DR−3, Weak/Fail에서는 락픽이 부서집니다. Strong은 통과, Weak는 통과하며 위험 공개, Fail은 막힌 채 위험 공개. 위험 표에서 잠긴 문/장애물이 다시 나오면 재굴림합니다.',
    book: 'depths',
    pages: [10],
    printedPage: 7,
    contexts: ['dungeon', 'room'],
    oracles: ['depths.danger'],
  },
  {
    id: 'depths.time-noise',
    title: 'Depths Time / Noise · 시간 지체와 소음',
    summary:
      '시간을 지체하거나 소음을 내면 위험 발생 확률 1/6. 오래 지체하거나 큰 소음이면 2/6. d6으로 확인하고 발생할 때만 Reveal a Danger를 굴립니다. 되돌아가기·휴식·긴 전투·문 부수기에도 적용합니다.',
    book: 'depths',
    pages: [11],
    printedPage: 8,
    contexts: ['dungeon', 'room', 'travel'],
    oracles: ['depths.danger'],
  },
  {
    id: 'depths.traps',
    title: 'Depths Traps · 함정 발견과 회피',
    summary:
      'TR Presence Move: Strong은 함정과 종류를 발견하고 가능하면 후퇴. Weak는 숨은 함정만 발견; TR Presence를 다시 굴려 Strong/Weak면 해제·회피, Fail이면 결과를 받습니다. 첫 발견에 Fail이면 Regular Traps로 종류를 정하고 해당 능력 판정을 합니다. 이 판정의 Strong은 무사히 회피, Weak/Fail은 선택된 함정의 결과를 적용합니다.',
    book: 'depths',
    pages: [12, 13],
    printedPage: '9–10',
    contexts: ['dungeon', 'room'],
    oracles: ['depths.traps.regular', 'depths.traps.special'],
    seeFullRule: true,
  },
  {
    id: 'sd.travel-day',
